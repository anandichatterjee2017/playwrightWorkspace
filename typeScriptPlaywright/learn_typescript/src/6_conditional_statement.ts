...
switch(randomNumber){
    case 0: console.log(`Number is zero : ${randomNumber}`);
            break;
    case 1: console.log(`Number is one : ${randomNumber}`);
            break;
    case 2: console.log(`Number is two : ${randomNumber}`);
            break;
    default: console.log("Number is either THREE or FOUR: "+randomNumber)
                break;
}